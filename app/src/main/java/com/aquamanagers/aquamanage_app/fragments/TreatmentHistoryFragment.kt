 ...
 * Use the [TreatmentHistoryFragment.newInstance] factory method to
...
class TreatmentHistoryFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TreatmentHistoryFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TreatmentHistoryFragment().apply {
